...
const gallery = [
  { id: 1, url: 'https://example.com/gallery1.jpg', caption: 'School Campus' },
  { id: 2, url: 'https://example.com/gallery2.jpg', caption: 'Classroom' },
  { id: 3, url: 'https://example.com/gallery3.jpg', caption: 'Sports Day' },
  { id: 4, url: 'https://example.com/gallery4.jpg', caption: 'Science Lab' },
];

const events = [
  { id: 1, title: 'Annual Sports Day', date: '2024-05-15', description: 'Join us for a day of fun and competition.' },
  { id: 2, title: 'Science Fair', date: '2024-06-20', description: 'Showcase of student projects and innovations.' },
  { id: 3, title: 'Independence Day Celebration', date: '2024-08-15', description: 'Celebrating our freedom with cultural programs.' },
];
